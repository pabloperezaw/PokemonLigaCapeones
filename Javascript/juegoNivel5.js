...
const opponentTeam = [
    {
        ...
        vel: 372,
        moves: [
            { name: "Surf", damage: 90, tipo: 'Agua' },
            { name: "Rayo", damage: 90, tipo: 'Electrico' },
            { name: "Ataque Rapido", damage: 40, tipo: 'Normal' },
            { name: "Cola Ferrea", damage: 100, tipo: 'Acero' },
        ],
    ...
    },
    {
        ...
        vel: 251,
        moves: [
            { name: "Asalto Estelar", damage: 150, tipo: 'Lucha' },
            { name: "Pájaro Osado", damage: 120, tipo: 'Volador' },
            { name: "Hoja Aguda", damage: 90, tipo: 'Planta' },
            { name: "Desarme", damage: 65, tipo: 'Siniestro' },
        ],
        tipoPrincipal: 'Lucha',
        tipoSecundario: null
    },
    {
        ...
        vel: 273,
        moves: [
            { name: "Carga Dragón", damage: 100, tipo: 'Dragon' },
            { name: "Branquibocado", damage: 85, tipo: 'Agua' },
            { name: "Triturar", damage: 80, tipo: 'Siniestro'},
            { name: "Psicocolmillo", damage: 85, tipo: 'Psiquico' },
        ],
        tipoPrincipal: 'Dragon',
        tipoSecundario: 'Agua'
    },
    {
        name: "Garchomp",
        ...
        vel: 333,
        moves: [
            { name: "Garra Dragón", damage: 80, tipo: 'Dragon' },
            { name: "Excavar", damage: 80, tipo: 'Tierra' },
            { name: "Colmillo Ígneo", damage: 65, tipo: 'Fuego' },
    ...
    },
    {
        ...
        moves: [
            ...
            { name: "Puño Hielo", damage: 75, tipo: 'Hielo' },
        ],
        tipoPrincipal: 'Lucha',
    ...
    },
    {
        ...
        moves: [
            ...
            { name: "Pulso Umbrio", damage: 80, tipo: 'Siniestro' },
...
function playerMove(moveName, damage, tipoMovimiento) {
    ...
    if (opponent.hp <= 0) {
        ...
        if (currentOpponentIndex >= opponentTeam.length) {
            logMessage("¡El Campeon de liga se ha quedado sin Pokemon! ¡Has ganado el primer combate!");
            detenerTemporizador();
            win = 1;
            if (win == 1) {
            ...
            logMessage(`¡${opponent.name} ha sido debilitado! ¡El Campeón de liga saca a ${opponentTeam[currentOpponentIndex].name}!`);
