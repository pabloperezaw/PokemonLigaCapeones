...
const opponentTeam = [
    {
        ...
        def: 328,
        moves: [
            { name: "Ventisca", damage: 110, tipo: 'Hielo' },
            { name: "Brillo Magico", damage: 80, tipo: 'Hada' },
            { name: "Pulso Umbrio", damage: 80, tipo: 'Siniestro' },
            { name: "Psicocarga", damage: 80, tipo: 'Psiquico' },
        ],
        tipoPrincipal: 'Hielo',
        tipoSecundario: 'Hada'
    },
    {
        ...
        def: 311,
        moves: [
            { name: "Chuzos", damage: 85, tipo: 'Hielo' },
            { name: "Asalto Espadon", damage: 120, tipo: 'Dragon'},
            { name: "Triturar", damage: 80, tipo: 'Siniestro' },
            { name: "Terremoto", damage: 100, tipo: 'Tierra' },
        ],
        tipoPrincipal: 'Hielo',
    ...
    },
    {
        ...
        def: 295,
        moves: [
            { name: "Tajo Umbrio", damage: 70, tipo: 'Siniestro' },
            { name: "Garra Metal", damage: 50, tipo: 'Acero' },
            { name: "Pirueta Helada", damage: 80, tipo: 'Hielo' },
    ...
    },
    {
        ...
        moves: [
            { name: "Chuzos", damage: 85, tipo: 'Hielo' },
            { name: "Concha Filo", damage: 75, tipo: 'Agua'},
            { name: "Cuerno Certero", damage: 70, tipo: 'Acero'},
            { name: "Puya Nociva", damage: 80, tipo: 'Veneno' },
        ],
        tipoPrincipal: 'Hielo',
        tipoSecundario: 'Agua'
    },
    {
        ...
        def: 438,
        moves: [
            { name: "Lanza Glacial", damage: 120, tipo: 'Hielo' },
            { name: "Cabezazo Zen", damage: 80, tipo: 'Psiquico' },
            { name: "Fuerza Equina", damage: 95, tipo: 'Tierra' },
            { name: "A Bocajarro", damage: 120, tipo: 'Lucha' },
        ],
        tipoPrincipal: 'Hielo',
        tipoSecundario: 'Psiquico'
    },
];
